...
from .views import students_new_bulk, students_list, students_new, students_update, students_delete
from .views import guests_list, guests_new, guests_update, guests_delete
