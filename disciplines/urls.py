...
from .views import disciplines_list, disciplines_new, disciplines_update, disciplines_delete, student_bulk_register
...
urlpatterns = [
    ...
    path('bulk/', student_bulk_register, name="student_bulk_register"),
]
